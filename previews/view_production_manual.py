...
class ProductionPrintPreview(QDialog):
    ...
    def build_story(self, styles):
        ...
        mat_table = Table(data, colWidths=[2.3 * inch, 2.05 * inch, 2.15 * inch, 1.5 * inch])
        ...
        mat_table.setStyle(TableStyle([
            ...
            ('TOPPADDING', (0, 0), (-1, 0), 5),   # top row
            ('BOTTOMPADDING', (0, 0), (-1, -1), 8),  # all
            ('BOTTOMPADDING', (0, -1), (-1, -1), 12),
            ('RIGHTPADDING', (1, 1), (2, -1), 10),  #  column 2 and 3
